            ...
            >
                ...
                >
                    ...
                    <Link
                        ...
                        href={menus.link}
                    >
                        <ApplicationLogo className="max-h-12 mx-auto fill-red-500"></ApplicationLogo>
                    </Link>
                    {/* <!-- User --> */}
                    ...
                    {/* <!-- Collapse --> */}
                    <div
                        className="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1"
                    >
                        {/* <!-- Collapse header --> */}
                        {/* <!-- Divider --> */}
