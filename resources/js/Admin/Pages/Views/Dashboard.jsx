    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="p-5 flex flex-wrap">
                <ComponentsProvider.CardInfoTotal title="Total Orders" color="text-pink-500 bg-pink-100" hoverColor="hover:text-pink-500" total={data.total_orders}>
                ...
                </ComponentsProvider.CardInfoTotal>

                <ComponentsProvider.CardInfoTotal title="Total Redeems" color="text-orange-500 bg-orange-100" hoverColor="hover:text-orange-500" total={data.total_redeems}>
                ...
                <ComponentsProvider.CardInfoTotal title="Total Users" color="text-slate-500 bg-slate-100" hoverColor="hover:text-slate-500" total={data.total_users}>
                ...
                <ComponentsProvider.CardInfoTotal title="Total Blogs" color="text-cyan-500 bg-cyan-100" hoverColor="hover:text-cyan-500" total={data.total_blogs}>
                ...
                <ComponentsProvider.CardInfoTotal title="Total Outlets" color="text-emerald-500 bg-emerald-100" hoverColor="hover:text-emerald-500" total={data.total_outlets}>
                ...
                <ComponentsProvider.CardInfoTotal title="Total Merchandise" color="text-rose-500 bg-rose-100" hoverColor="hover:text-rose-500" total={data.total_merchandise}>
                ...
                <ComponentsProvider.CardInfoTotal title="Total Events" color="text-blue-500 bg-blue-100" hoverColor="hover:text-blue-500" total={data.total_events}>
